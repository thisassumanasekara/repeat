                ...
                ?>
                        <form action="code/device-edit.php" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_name" value="<?php echo $row['mobile_name'] ?>" class="form-control" placeholder="Enter Mobile Name">
                            </div>
                            <div class="form-group">
                                <label>Mobile Price</label>
                                <input type="text" name="edit_price" value="<?php echo $row['mobile_price'] ?>" class="form-control" placeholder="Enter Mobile price">
                            </div>
                            <div class="form-group">
                                <label>64 Stock</label>
                                <input type="text" name="edit_64" value="<?php echo $row['64_stock'] ?>" class="form-control" placeholder="Enter Stock">
                            </div>
                            <div class="form-group">
                                <label>128 Stock</label>
                                <input type="text" name="edit_128" value="<?php echo $row['128_stock'] ?>" class="form-control" placeholder="Enter Stock">
                            </div>
                            <div class="form-group">
                                <label>256 Stock</label>
                                <input type="text" name="edit_256" value="<?php echo $row['256_stock'] ?>" class="form-control" placeholder="Enter Stock">
                            </div>
                            <div class="form-group">
